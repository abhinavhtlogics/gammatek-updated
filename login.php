            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" action="login_process.php" id="ajaxform">
             ...
             <div class="col-md-12 alert alert-danger" role="alert"  id="message" style="display:none;">
                                           
                                        </div> 


              <div class="col-md-12 alert alert-success" role="alert"  id="message2" style="display:none;">
    ...
    jQuery.ajax({
           ...
           success: function(data)
           {
			...
			if(data.status==true){
                ...
                jQuery("input[type=file],textarea").val('');				
				jQuery('#message2').html(data.message);  
				 
				jQuery("#message2").fadeIn(100);
				jQuery("html, body").animate({
				scrollTop: jQuery("#message2").offset().top-100
				}, 1000);
				jQuery("#message2").delay(3000);
				jQuery("#message2").fadeOut(100);                		
				 window.location.href='https://gammatek-app.herokuapp.com/';
